...
public class PosicionTest {
	...
	private static final String POSICION_NO_ESPERADA = "La posición copiada deberá ser la misma que la pasada como parámetro.";
	...
	private static final String OBJETO_DEBERIA_SER_NULL = "No se deberá haber creado el objeto posición.";
	...
	private static final String EXCEPCION_COLUMNA_INCORRECTA = "Deberá haber saltado una excepción indicando que la columna es incorrecta";
	private static final String EXCEPCION_FILA_INCORRECTA = "Deberá haber saltado una excepción indicando que la fila es incorrecta";
	private static final String EXCEPCION_POSICION_NULA = "Deberá haber saltado una excepción indicando que no se puede copiar una posición nula.";
